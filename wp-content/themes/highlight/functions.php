...
function highlight_get_footer_copyright($copyright, $preview_atts)
{
    ...
    $copyrightText = __('Built by %s', 'highlight');
    $copyrightText = sprintf($copyrightText, '<a target="_blank" href="%1$s" class="mesmerize-theme-link">Sunil Shrestha</a>');
    
    $copyrightText = sprintf($copyrightText, 'https://www.instagram.com/_s00nil_/?hl=en');
